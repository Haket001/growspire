 ...
 */
	...
	if( $enable_footer == 'enable' || $enable_copyright == 'enable' ){
		...
		if( $fixed_footer == 'enable' ){
			...
			echo '<footer id="seocrawler-footer">';
		}
		...
		if( $enable_copyright == 'enable' ){
			...
			if( $copyright_style == 'center' ){
				...
				if( !empty($copyright_left) || !empty($copyright_right) ){
					...
					<div id="footer_menu">
						<ul>
							<li><a href="https://drive.google.com/open?id=1tBdGL4B7ssM1-65MAUW5IhYzUtum14Cf" target="_blank">Privacy Policy</a></li>
							<li><a href="https://drive.google.com/file/d/18xzGEp_AfAk6W0lypkpzo9R74QhlwTFy/view" target="_blank">Cookie Policy</a></li>
							<li><a href="<?php echo home_url('/')?>data-access-request/">Data Access Request</a></li>
						</ul>
					</div>
					<?php
...
<script src="https://widget.flowxo.com/embed.js" data-fxo-widget="eyJ0aGVtZSI6IiNlYjQzMDAiLCJ3ZWIiOnsiYm90SWQiOiI1ZDY5M2FhZjgwNGU5MzAwYWEzOGI2OGEiLCJ0aGVtZSI6IiNlYjQzMDAifSwid2VsY29tZVRleHQiOiJIaSwgSSBhbSBoZXJlKSBDbGljayB0aGUgYnV0dG9uIHNvIHdlIGNoYXQpIn0=" async defer></script>
