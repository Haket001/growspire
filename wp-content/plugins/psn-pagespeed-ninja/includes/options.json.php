  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "title": "<?php _e('Global Above-the-fold CSS'); ?>",
        "tooltip": "<?php _e('By default, Above-the-fold CSS styles are used on the homepage only. With this option enabled you can use CSS these styles on all pages of the website, but note that some themes have page-dependent styles and, as a result, are not compatible with this option.'); ?>",
        "type": "checkbox",
        "default": 0,
        "presets": {
          "ultra": 1
