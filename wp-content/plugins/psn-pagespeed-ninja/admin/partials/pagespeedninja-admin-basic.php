...
?>
<div class="psnwrap">
    <?php if (!$config['email_submitted']): ?>
        <div id="pagespeedninja_emailform_popup" style="display:none">
            <div id="pagespeedninja_emailform">
                <form action="options.php" method="post">
                    <?php settings_fields('pagespeedninja_config'); ?>
                    <input type="hidden" name="pagespeedninja_config[email_submitted]" value="1" />
                    <p><?php _e('Sign up to receive our email newsletter and stay informed with the latest news, promotions, and updates from our team.'); ?></p>
